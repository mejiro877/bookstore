...
return [
    ...
    'confirmed' => ':attributeと:attribute（確認用）は同じ値を入力してください。',
    ...
    'positive_integer' => ':attributeには正の数で入力してください。',
    'zip_code' => ':attributeはXXX-XXXXの形式で入力してください。',
    'tel' => ':attributeは半角数字とハイフンで入力してください。',
    'gt' => [
        'numeric' => ':attributeは金額下限より大きい値を入力してください。',
    ],
